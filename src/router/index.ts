...
//-- mis componentes
import AnalyticsCartera from "../hito/Cartera/AnalyticsCartera.vue";
import ListCarteraPage from "@/hito/Cartera/ListCarteras.vue";
...
const routes = [

  {
    ...
    component: AnalyticsCartera,
  },
  {
    path: "/ListCarteras",
    name: "ListCarteras",
    component: ListCarteraPage,
  },
  {
    path: "/ProjectManagementPage",
